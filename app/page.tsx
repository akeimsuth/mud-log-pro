        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white mb-8">
          <div className="max-w-4xl">
            ...
            <div className="flex space-x-4">
              <Link 
                href="/upload" 
                className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors whitespace-nowrap cursor-pointer"
              >
                Upload Data
              </Link>
              <Link 
                href="/correction" 
                className="bg-blue-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-400 transition-colors whitespace-nowrap cursor-pointer"
              >
                View Corrections
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{systemStats.filesProcessed}</p>
                <p className="text-gray-500 dark:text-gray-400 text-sm">Files Processed</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{systemStats.wellsLogged}</p>
                <p className="text-gray-500 dark:text-gray-400 text-sm">Wells Logged</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-sm">Data Points</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-orange-100 dark:bg-orange-900 rounded-lg flex items-center justify-center">
                <i className="ri-pulse-line text-orange-600 text-xl"></i>
              </div>
              <div>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">{systemStats.uptime}</p>
                <p className="text-gray-500 dark:text-gray-400 text-sm">System Uptime</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Upload New Data</h3>
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Import CSV or Excel files for processing</p>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Review Corrections</h3>
                  <p className="text-gray-500 dark:text-gray-400 text-sm">View and adjust drift corrections</p>
                </div>
                <div className="w-6 h-6 flex items-center justify-center">
                  <i className="ri-arrow-right-line text-gray-400"></i>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-gray-900 dark:text-white">Export LAS Files</h3>
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Generate standardized output files</p>
                </div>
                <div className="w-6 h-6 flex items-center justify-center">
                  <i className="ri-arrow-right-line text-gray-400"></i>
                </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm">Customize profiles and templates</p>
                </div>
                <div className="w-6 h-6 flex items-center justify-center">
                  <i className="ri-arrow-right-line text-gray-400"></i>
                </div>
              ...
              {recentFiles.map((file, index) => (
                <div key={index} className="flex items-center space-x-4 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">{file.date} • {file.size}</p>
                  </div>
        ...
        <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-gray-700 dark:text-gray-300">Processing Engine: Online</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-green-500 rounded-full"></div>
              <span className="text-gray-700 dark:text-gray-300">Data Storage: Available</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-yellow-500 rounded-full"></div>
              <span className="text-gray-700 dark:text-gray-300">API Connection: Limited</span>
            </div>
          </div>
        </div>
      </main>
