        ...
        {activeTab === 'preview' && (
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-3 sm:p-4">
              <pre className="text-xs sm:text-sm text-gray-700 dark:text-gray-300 overflow-auto max-h-64 sm:max-h-96 whitespace-pre-wrap">
                {previewContent}
              </pre>
            </div>
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <div className="flex items-start space-x-2">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center mt-0.5">
                    <i className="ri-error-warning-line text-yellow-600 text-sm"></i>
                  </div>
                  <div>
                    <h3 className="font-semibold text-yellow-800 dark:text-yellow-200 text-sm sm:text-base mb-1 sm:mb-2">
                      Validation Warnings
                    </h3>
                    <ul className="space-y-1">
                      {validationWarnings.map((warning, index) => (
                        <li key={index} className="text-yellow-700 dark:text-yellow-300 text-xs sm:text-sm">
                          • {warning}
                        </li>
                      ))}
                    </ul>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <label key={format.value} className="flex items-start space-x-2 sm:space-x-3 cursor-pointer">
                        <input
                          type="radio"
                          name="exportFormat"
                          value={format.value}
                        ...
                        />
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">{format.label}</p>
                          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{format.description}</p>
                        </div>
                      </label>
                    ))}
                  </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <label key={dest.value} className="flex items-start space-x-2 sm:space-x-3 cursor-pointer">
                        <input
                          type="radio"
                        ...
                        />
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white text-sm sm:text-base">{dest.label}</p>
                          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">{dest.description}</p>
                        </div>
                      </label>
                    ))}
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 sm:p-6">
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">Well Name:</span>
                  <span className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">
                    {metadata.find(f => f.key === 'wellName')?.value}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">Export Format:</span>
                  <span className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">
                    {exportFormat.toUpperCase()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">Destination:</span>
                  <span className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm">Depth Range:</span>
                  <span className="font-medium text-gray-900 dark:text-white text-xs sm:text-sm">
              ...
              {isExporting ? (
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-center py-3 sm:py-4">
                    <div className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center mr-2 sm:mr-3">
                      <i className="ri-loader-4-line text-xl sm:text-2xl text-blue-600 animate-spin"></i>
                    </div>
                    <span className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Exporting...</span>
                  </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 sm:px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer text-sm sm:text-base"
                >
              ...
              <div className="mt-3 sm:mt-4 text-center">
                <Link 
                  href="/" 
                  className="text-blue-600 hover:text-blue-700 text-xs sm:text-sm cursor-pointer whitespace-nowrap"
                >
                  Return to Dashboard
                </Link>
              </div>
